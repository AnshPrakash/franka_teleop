...
class VRPolicyFranka:
    ...
    def _calculate_action(self, state_dict, include_info=False):
        ...
        info_dict = { 
                        ...
                        "B": self._state["buttons"]["B"],    # this line is added by Sophie
                        "RTr" : self._state["buttons"]["RTr"], # this line is added by Ansh
                        "RG" : self._state["buttons"]["RG"], # this line is added by Ansh,
                        "rightJS": self._state["buttons"]['rightJS']
                    }
